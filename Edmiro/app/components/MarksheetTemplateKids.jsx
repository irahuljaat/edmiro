...
export default function MarksheetTemplateKids({ 
        ...
        const unsubscribe = onSnapshot(schoolDetailsRef, (docSnap) => {
            if (docSnap.exists()) {
                ...
                setSchoolDetails({
                    ...
                    logoUrl: sData.schoolLogo || sData.logoUrl || DEFAULT_SCHOOL_LOGO,
                    marksheetsFront: sData.marksheetsFront || sData.frontImage || DEFAULT_FRONT_GRAPHIC
                });
            }
        }, (err) => {
    ...
    return (
        <div className="flex flex-col items-center gap-10 bg-slate-100 print:bg-white print:gap-0 print:p-0 select-none text-slate-800">
            ...
            {/* ========================================================= */}
            {/* PAGE 2: MARKSHEET EVALUATION & CLASS REPORT (UNCHANGED)   */}
            {/* ========================================================= */}
            <div 
