...
export default function EditStudentForm({ studentData, onClose, onStudentUpdated, activeSession, schoolId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (newSrNo !== oldSrNo || formData.grade !== studentData.grade) {
                ...
                const newDocRef = doc(db, 'Data', schoolId, 'sessions', activeSession, 'students', newId);
                await setDoc(newDocRef, updatedData);

                const oldDocRef = doc(db, 'Data', schoolId, 'sessions', activeSession, 'students', oldId);
                await deleteDoc(oldDocRef);
            } else {
                const studentRef = doc(db, 'Data', schoolId, 'sessions', activeSession, 'students', oldId);
