...
const SingleStudentFormContent = memo(({ onClose, onStudentAdded, activeSession, schoolId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Write student record to: Data -> {schoolId} -> sessions -> {activeSession} -> students -> {generatedId}
            await setDoc(doc(db, 'Data', schoolId, 'sessions', activeSession, 'students', generatedId), studentData);
    ...
    return (
        <div className="p-6 md:p-8 space-y-8 relative overflow-hidden" style={{ backgroundColor: colors.background }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <button 
                    type="submit" 
                    disabled={loading || !activeSession || !schoolId} 
                    style={{ 
...
export default function AddStudentForm({ onClose, onStudentAdded, activeSession, schoolId }) {
