...
function DocumentSelector({ activeSession, schoolId = 'TEST_EDMIRO_ACADEMY' }) {
    ...
    if (selectedDocument === DOC_TYPES.MARKSHEET) {
        return <MarksheetGenerator onBack={handleBack} activeSession={activeSession} schoolId={schoolId} />;
    }

    if (selectedDocument === DOC_TYPES.ADMIT_CARD) {
        return <DocumentGenerator onBack={handleBack} activeSession={activeSession} schoolId={schoolId} />;
    }
            ...
            <div className="relative z-10 space-y-8 animate-in fade-in duration-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <button
                        ...
                        className="group relative bg-white p-6 md:p-8 rounded-[28px] border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 text-left overflow-hidden cursor-pointer"
                    >
                        ...
                        <p className="text-slate-500 text-xs leading-relaxed font-medium mb-6">
                            Generate final academic reports, calculate grades, ranks, and attendance for class-wide distribution[cite: 15].
                        </p>
